...
const
  htdPluginShortName = 'MirandaHistoryToDB';
  ...
  htdCopyright_EN    = '(c) 2011-2012 Michael Grigorev';
  htdCopyright_RU    = '(c) 2011-2012 Michael Grigorev';
  htdHomePageURL  = 'http://www.im-history.ru/';
  htdVerMajor     = {MAJOR_VER}2{/MAJOR_VER};
  htdVerMinor     = {MINOR_VER}4{/MINOR_VER};
  ...
  htdUpdateURL      = 'http://www.im-history.ru/get.php?file=MirandaHistoryToDB';
  htdVersionURL     = 'http://www.im-history.ru/get.php?file=MirandaHistoryToDB-Version';
  ...
  MIID_HISTORYTODBDLL = '{1F83C057-C59F-483B-B82E-1AE5CA6138EB}';

  MS_MHTD_SHOWHISTORY: PAnsiChar = 'MirandaHistoryToDB/ShowHistory';
  MS_MHTD_GETVERSION: PAnsiChar = 'MirandaHistoryToDB/GetVersion';
  MS_MHTD_SHOWCONTACTHISTORY: PAnsiChar = 'MirandaHistoryToDB/ShowContactHistory';
