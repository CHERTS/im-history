...
//    LPARAM                  = Integer;
    ...
    {$ifdef FPC}
        TStrCpy = function(Dst, Src: PAnsiChar): PAnsiChar;
    {$else}
        TStrCpy = function(Dst, Src: PAnsiChar): PAnsiChar; stdcall;
    {$endif}

    // strcat()

    {$ifdef FPC}
        TStrCat = function(Dst, Src: PAnsiChar): PAnsiChar;
    {$else}
        TStrCat = function(Dst, Src: PAnsiChar): PAnsiChar; stdcall;
    {$endif}
...
const
    ...
    {$else}
        strcpy: TStrCpy = lstrcpya;
    {$endif}

    {$ifdef FPC}
        strcat: TStrCat = strings.strcat;
    {$else}
        strcat: TStrCat = lstrcata;
    {$endif}
